...
class UnknownException extends CustomException {
  UnknownException(errorCode, [message])
      : super(errorCode, message, 'Unknown Error');
}
...
class UnprocessableEntityException extends CustomException {
  UnprocessableEntityException(errorCode, [message])
      : super(errorCode, message, 'Unprocessable Entity Exception');
}
